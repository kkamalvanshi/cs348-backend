...
# Fetching environment variables and setting the database URI
...
engine = create_engine(
    f'mysql+pymysql://{db_user}:{db_password}@/{db_name}?unix_socket={unix_socket}',
    isolation_level="SERIALIZABLE"
)

# Optionally, use scoped_session and sessionmaker for more control
db.session = scoped_session(sessionmaker(bind=engine, autoflush=False, autocommit=False))
...
@app.route('/')
def index():
    return "Welcome to the Machine Learning Model Registry!"
